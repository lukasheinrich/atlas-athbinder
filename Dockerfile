...
USER atlas
RUN source ~/release_setup.sh && pip install -U pip install metakernel zmq  --user
RUN source ~/release_setup.sh  && cp -r $ROOTSYS/etc/notebook/kernels/root ~/.local/share/jupyter/kernels
